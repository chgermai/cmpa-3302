...
A similar category is [[_example-files/example-category-01/index| Category 01]], which also uses the `index.md` method to specify a category page title and descriptive text.